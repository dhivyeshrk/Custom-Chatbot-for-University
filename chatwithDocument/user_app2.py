...
if __name__ == "__main__":
    ...
    vector_store = Chroma(persist_directory=r"C:\Users\DELL\DataspellProjects\Chatbot_Test_2\ChatWithDocument\Data_Files_3",
    ...
    if q and get_similar_use_case(q)[0] > 0.5:
        ...
        if yesno1.lower() == 'yes':
            ...
            if yesno2.lower() == 'yes':
                ...
                mail_types = ["Medical Certificate", "Fee Information", "Guest House Booking", "Open"]
    ...
    else : # if the user entered a question and hit enter
